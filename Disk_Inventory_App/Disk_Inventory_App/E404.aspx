<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="E404.aspx.cs" Inherits="E404" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <img src="Img/source.gif" class="img-responsive img-rounded" alt="Star wars imperial walker" />
            </div>
        </div>
        <%--row 2--%>
        <div class="row">
